...
class WeibosControllerTest < ActionController::TestCase
  ...
  test "should create weibo" do
    assert_difference('Weibo.count') do
      post :create, weibo: { content: @weibo.content, ctime: @weibo.ctime, flag: @weibo.flag, type: @weibo.type, userid: @weibo.userid }
    end
  ...
  test "should update weibo" do
    put :update, id: @weibo, weibo: { content: @weibo.content, ctime: @weibo.ctime, flag: @weibo.flag, type: @weibo.type, userid: @weibo.userid }
    assert_redirected_to weibo_path(assigns(:weibo))
  end
